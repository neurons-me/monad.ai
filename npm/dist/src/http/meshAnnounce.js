...
function parseEntry(body, now) {
    ...
    return {
        ...
        claimed_namespaces: Array.isArray(body?.claimed_namespaces)
            ? body.claimed_namespaces.map(String)
            : [namespace],
 ...
 */
export function createMeshAnnounceRouter() {
 ...
 */
export async function announceToSurface(surfaceUrl, entry) {
