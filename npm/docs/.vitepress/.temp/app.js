...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"monad.ai","description":"Daemon runtime and ledger host for the me:// protocol.","base":"/monad.ai/npm/docs/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"Guide","link":"/"},{"text":"Routing","link":"/nrp-routing-spec"},{"text":"Exchange","link":"/nrp-remote-exchange-spec"},{"text":"API","link":"/api/"}],"sidebar":[{"text":"Guide","items":[{"text":"Overview","link":"/"},{"text":"Routing Spec","link":"/nrp-routing-spec"},{"text":"Remote Exchange Spec","link":"/nrp-remote-exchange-spec"}]},{"text":"API","items":[{"text":"Generated API","link":"/api/"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/neurons-me/monad.ai"}]},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
